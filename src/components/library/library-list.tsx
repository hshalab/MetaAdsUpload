...
const COLUMNS: { key: string; label: string; sortAsc?: SortOption; sortDesc?: SortOption; className?: string }[] = [
  ...
  { key: "spend", label: "Spend", sortDesc: "spend_desc", className: "w-24" },
  { key: "roas", label: "ROAS", sortDesc: "roas_desc", className: "w-20" },
  { key: "hook", label: "Hook", sortDesc: "hook_desc", className: "w-20" },
  { key: "hold", label: "Hold", sortDesc: "hold_desc", className: "w-20" },
